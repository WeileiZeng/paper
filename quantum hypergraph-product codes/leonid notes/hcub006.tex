...
2            &1(?) &   \begin{minipage}[c]{1.5in}
    ...
    3&  1 (?)&   \begin{minipage}[c]{1.7in}
                   $\tilde{\kappa}_3>0:  \;  
                   \min(d_1^{(m=2)},\delta_3)$\hfill\strut\\
                   $\tilde{\kappa}_3=0:  \;
                   \delta_3$\hfill\strut
                 \end{minipage} 
...
\\ \hline 
    4 & 1(?) &  \begin{minipage}[c]{1.7in}
      $\tilde{\kappa}_4>0:  \;  
      \min(d_1^{(m=3)},\delta_4)$\hfill\strut\\
      $\tilde{\kappa}_4=0:  \;
      \delta_4$\hfill\strut
